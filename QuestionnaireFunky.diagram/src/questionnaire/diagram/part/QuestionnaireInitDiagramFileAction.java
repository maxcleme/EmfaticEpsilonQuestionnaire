 ...
 * @generated
 */
public class QuestionnaireInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new QuestionnaireNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				QuestionnaireEditPart.MODEL_ID));
		QuestionnaireDiagramEditorUtil.runWizard(getShell(), wizard,
