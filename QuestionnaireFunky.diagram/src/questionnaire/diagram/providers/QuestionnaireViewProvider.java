 ...
 * @generated
 */
public class QuestionnaireViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return QuestionnaireEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = QuestionnaireVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = QuestionnaireVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!QuestionnaireElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != QuestionnaireVisualIDRegistry
				...
				if (!QuestionnaireEditPart.MODEL_ID
						.equals(QuestionnaireVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return TexteEditPart.VISUAL_ID == visualID
				|| QuestionOuverteEditPart.VISUAL_ID == visualID
				|| QuestionOuiNonEditPart.VISUAL_ID == visualID
				|| QuestionReponseMultipleEditPart.VISUAL_ID == visualID
				|| TypeSaisieNumeriqueEditPart.VISUAL_ID == visualID
				|| TypeSaisieAlphaNumeriqueEditPart.VISUAL_ID == visualID
				|| TypeSaisieAlphaEditPart.VISUAL_ID == visualID
				|| TypeSaisieAllEditPart.VISUAL_ID == visualID
				|| AiguilleurEditPart.VISUAL_ID == visualID
				|| TestEntreEditPart.VISUAL_ID == visualID
				|| TestInferieurEditPart.VISUAL_ID == visualID
				|| TestSuperieurEditPart.VISUAL_ID == visualID
				|| TestEgaliteEditPart.VISUAL_ID == visualID
				|| FinEditPart.VISUAL_ID == visualID
				|| DebutEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = QuestionnaireVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(QuestionnaireEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = QuestionnaireVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TexteEditPart.VISUAL_ID:
			return createTexte_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case QuestionOuverteEditPart.VISUAL_ID:
			return createQuestionOuverte_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case QuestionOuiNonEditPart.VISUAL_ID:
			return createQuestionOuiNon_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case QuestionReponseMultipleEditPart.VISUAL_ID:
			return createQuestionReponseMultiple_2004(domainElement,
					containerView, index, persisted, preferencesHint);
		case TypeSaisieNumeriqueEditPart.VISUAL_ID:
			return createTypeSaisieNumerique_2005(domainElement, containerView,
					index, persisted, preferencesHint);
		case TypeSaisieAlphaNumeriqueEditPart.VISUAL_ID:
			return createTypeSaisieAlphaNumerique_2006(domainElement,
					containerView, index, persisted, preferencesHint);
		case TypeSaisieAlphaEditPart.VISUAL_ID:
			return createTypeSaisieAlpha_2007(domainElement, containerView,
					index, persisted, preferencesHint);
		case TypeSaisieAllEditPart.VISUAL_ID:
			return createTypeSaisieAll_2008(domainElement, containerView,
					index, persisted, preferencesHint);
		case AiguilleurEditPart.VISUAL_ID:
			return createAiguilleur_2009(domainElement, containerView, index,
					persisted, preferencesHint);
		case TestEntreEditPart.VISUAL_ID:
			return createTestEntre_2010(domainElement, containerView, index,
					persisted, preferencesHint);
		case TestInferieurEditPart.VISUAL_ID:
			return createTestInferieur_2011(domainElement, containerView,
					index, persisted, preferencesHint);
		case TestSuperieurEditPart.VISUAL_ID:
			return createTestSuperieur_2012(domainElement, containerView,
					index, persisted, preferencesHint);
		case TestEgaliteEditPart.VISUAL_ID:
			return createTestEgalite_2013(domainElement, containerView, index,
					persisted, preferencesHint);
		case FinEditPart.VISUAL_ID:
			return createFin_2014(domainElement, containerView, index,
					persisted, preferencesHint);
		case DebutEditPart.VISUAL_ID:
			return createDebut_2015(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (QuestionnaireVisualIDRegistry.getVisualID(elementTypeHint)) {
		case DebutPremiereQuestionEditPart.VISUAL_ID:
			return createDebutPremiereQuestion_4001(containerView, index,
					persisted, preferencesHint);
		case AiguilleurTestsEditPart.VISUAL_ID:
			return createAiguilleurTests_4002(containerView, index, persisted,
					preferencesHint);
		case AiguilleurElseDestinationEditPart.VISUAL_ID:
			return createAiguilleurElseDestination_4003(containerView, index,
					persisted, preferencesHint);
		case QuestionSuiteEditPart.VISUAL_ID:
			return createQuestionSuite_4004(containerView, index, persisted,
					preferencesHint);
		case QuestionTypeSaisieEditPart.VISUAL_ID:
			return createQuestionTypeSaisie_4005(containerView, index,
					persisted, preferencesHint);
		case TestDestinationEditPart.VISUAL_ID:
			return createTestDestination_4006(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTexte_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(QuestionnaireVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createQuestionOuverte_2002(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createQuestionOuiNon_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createQuestionReponseMultiple_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTypeSaisieNumerique_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTypeSaisieAlphaNumerique_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTypeSaisieAlpha_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTypeSaisieAll_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createAiguilleur_2009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTestEntre_2010(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(QuestionnaireVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createTestInferieur_2011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTestSuperieur_2012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createTestEgalite_2013(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createFin_2014(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(QuestionnaireVisualIDRegistry
		...
		Node label5014 = createLabel(node,
				QuestionnaireVisualIDRegistry.getType(FinNomEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createDebut_2015(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(QuestionnaireVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createDebutPremiereQuestion_4001(View containerView, int index,
		...
		edge.setType(QuestionnaireVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAiguilleurTests_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createAiguilleurElseDestination_4003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createQuestionSuite_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createQuestionTypeSaisie_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createTestDestination_4006(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	...
	private void stampShortcut(View containerView, Node target) {
		if (!QuestionnaireEditPart.MODEL_ID
				.equals(QuestionnaireVisualIDRegistry.getModelID(containerView))) {
