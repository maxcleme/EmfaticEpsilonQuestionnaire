...
import questionnaire.diagram.part.QuestionnaireDiagramEditorUtil;

/**
 * @generated
 */
public class QuestionnaireMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = QuestionnaireDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			QuestionnaireDiagramEditorUtil.selectElementsInDiagram(editor,
