 ...
 * @generated
 */
public class AiguilleurTestsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AiguilleurTestsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Test && newEnd instanceof Aiguilleur)) {
			return false;
		}
		return QuestionnaireBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAiguilleurTests_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return QuestionnaireBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAiguilleurTests_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getTests().remove(getOldTarget());
		getNewSource().getTests().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getTests().remove(getOldTarget());
		getOldSource().getTests().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
