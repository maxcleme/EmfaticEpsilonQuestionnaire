 ...
 * @generated
 */
public class QuestionnaireCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public QuestionnaireCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", QuestionnaireEditPart.MODEL_ID); //$NON-NLS-1$
