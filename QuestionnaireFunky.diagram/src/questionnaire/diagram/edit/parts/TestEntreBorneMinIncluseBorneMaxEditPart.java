 ...
 * @generated
 */
public class TestEntreBorneMinIncluseBorneMaxEditPart extends
	 ...
	 * @generated
	 */
	public TestEntreBorneMinIncluseBorneMaxEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TestEntreBorneMinIncluseBorneMaxEditPart.VISUAL_ID));
		}
		return parser;
	}
