 ...
 * @generated
 */
public class TypeSaisieAlphaRegexEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TypeSaisieAlphaRegexEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QuestionnaireParserProvider
					.getParser(
							QuestionnaireElementTypes.TypeSaisieAlpha_2007,
							getParserElement(),
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TypeSaisieAlphaRegexEditPart.VISUAL_ID));
		}
		return parser;
	}
