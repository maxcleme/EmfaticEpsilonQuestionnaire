 ...
 * @generated
 */
public class TypeSaisieAlphaNumeriqueRegexEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public TypeSaisieAlphaNumeriqueRegexEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TypeSaisieAlphaNumeriqueRegexEditPart.VISUAL_ID));
		}
		return parser;
	}
