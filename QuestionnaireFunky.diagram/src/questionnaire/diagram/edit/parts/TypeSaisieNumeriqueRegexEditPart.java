...
import questionnaire.diagram.edit.policies.QuestionnaireTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TypeSaisieNumeriqueRegexEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public TypeSaisieNumeriqueRegexEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new QuestionnaireTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return QuestionnaireElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QuestionnaireParserProvider
					.getParser(
							QuestionnaireElementTypes.TypeSaisieNumerique_2005,
							getParserElement(),
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TypeSaisieNumeriqueRegexEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					QuestionnaireEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
