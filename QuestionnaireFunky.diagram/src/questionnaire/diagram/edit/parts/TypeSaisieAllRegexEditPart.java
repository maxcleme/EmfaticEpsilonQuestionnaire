 ...
 * @generated
 */
public class TypeSaisieAllRegexEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TypeSaisieAllRegexEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TypeSaisieAllRegexEditPart.VISUAL_ID));
		}
		return parser;
	}
