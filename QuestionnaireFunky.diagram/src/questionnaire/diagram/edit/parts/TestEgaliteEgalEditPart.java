 ...
 * @generated
 */
public class TestEgaliteEgalEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TestEgaliteEgalEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TestEgaliteEgalEditPart.VISUAL_ID));
		}
		return parser;
	}
