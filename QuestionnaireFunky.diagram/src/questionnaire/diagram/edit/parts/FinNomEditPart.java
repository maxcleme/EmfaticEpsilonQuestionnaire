 ...
 * @generated
 */
public class FinNomEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FinNomEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QuestionnaireParserProvider
					.getParser(
							QuestionnaireElementTypes.Fin_2014,
							getParserElement(),
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.FinNomEditPart.VISUAL_ID));
		}
		return parser;
	}
