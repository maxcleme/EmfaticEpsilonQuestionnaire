 ...
 * @generated
 */
public class QuestionOuiNonQuestionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public QuestionOuiNonQuestionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QuestionnaireParserProvider
					.getParser(
							QuestionnaireElementTypes.QuestionOuiNon_2003,
							getParserElement(),
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.QuestionOuiNonQuestionEditPart.VISUAL_ID));
		}
		return parser;
	}
