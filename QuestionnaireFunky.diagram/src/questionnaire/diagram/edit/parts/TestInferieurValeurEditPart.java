 ...
 * @generated
 */
public class TestInferieurValeurEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TestInferieurValeurEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TestInferieurValeurEditPart.VISUAL_ID));
		}
		return parser;
	}
