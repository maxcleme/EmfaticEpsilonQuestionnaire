 ...
 * @generated
 */
public class AiguilleurNomEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AiguilleurNomEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.AiguilleurNomEditPart.VISUAL_ID));
		}
		return parser;
	}
