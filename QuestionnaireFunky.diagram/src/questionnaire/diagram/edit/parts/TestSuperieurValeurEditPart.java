 ...
 * @generated
 */
public class TestSuperieurValeurEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TestSuperieurValeurEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.TestSuperieurValeurEditPart.VISUAL_ID));
		}
		return parser;
	}
