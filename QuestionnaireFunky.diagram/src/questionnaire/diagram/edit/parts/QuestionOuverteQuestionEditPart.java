 ...
 * @generated
 */
public class QuestionOuverteQuestionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public QuestionOuverteQuestionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QuestionnaireParserProvider
					.getParser(
							QuestionnaireElementTypes.QuestionOuverte_2002,
							getParserElement(),
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.QuestionOuverteQuestionEditPart.VISUAL_ID));
		}
		return parser;
	}
