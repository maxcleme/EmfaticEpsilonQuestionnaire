 ...
 * @generated
 */
public class QuestionReponseMultipleQuestionEditPart extends
	 ...
	 * @generated
	 */
	public QuestionReponseMultipleQuestionEditPart(View view) {
		super(view);
	}
			...
			parser = QuestionnaireParserProvider
					.getParser(
							...
							QuestionnaireVisualIDRegistry
									.getType(questionnaire.diagram.edit.parts.QuestionReponseMultipleQuestionEditPart.VISUAL_ID));
		}
		return parser;
	}
