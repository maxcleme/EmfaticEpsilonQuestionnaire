...
import questionnaire.diagram.edit.commands.DebutPremiereQuestionCreateCommand;
import questionnaire.diagram.edit.commands.DebutPremiereQuestionReorientCommand;
...
import questionnaire.diagram.edit.commands.QuestionTypeSaisieCreateCommand;
import questionnaire.diagram.edit.commands.QuestionTypeSaisieReorientCommand;
 ...
 * @generated
 */
public class QuestionReponseMultipleItemSemanticEditPolicy extends
		QuestionnaireBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public QuestionReponseMultipleItemSemanticEditPolicy() {
		super(QuestionnaireElementTypes.QuestionReponseMultiple_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (QuestionnaireVisualIDRegistry.getVisualID(incomingLink) == DebutPremiereQuestionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (QuestionnaireVisualIDRegistry.getVisualID(outgoingLink) == QuestionSuiteEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (QuestionnaireVisualIDRegistry.getVisualID(outgoingLink) == QuestionTypeSaisieEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (QuestionnaireElementTypes.DebutPremiereQuestion_4001 == req
				.getElementType()) {
			return null;
		}
		...
		if (QuestionnaireElementTypes.QuestionTypeSaisie_4005 == req
				.getElementType()) {
			return getGEFWrapper(new QuestionTypeSaisieCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (QuestionnaireElementTypes.DebutPremiereQuestion_4001 == req
				.getElementType()) {
			return getGEFWrapper(new DebutPremiereQuestionCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (QuestionnaireElementTypes.AiguilleurElseDestination_4003 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case DebutPremiereQuestionEditPart.VISUAL_ID:
			return getGEFWrapper(new DebutPremiereQuestionReorientCommand(req));
		...
		case QuestionTypeSaisieEditPart.VISUAL_ID:
			return getGEFWrapper(new QuestionTypeSaisieReorientCommand(req));
