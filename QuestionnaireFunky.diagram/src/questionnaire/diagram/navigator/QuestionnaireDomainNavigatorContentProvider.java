 ...
 * @generated
 */
public class QuestionnaireDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public QuestionnaireDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof QuestionnaireDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((QuestionnaireDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new QuestionnaireDomainNavigatorItem(
